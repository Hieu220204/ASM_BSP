...
productDetails_df = pd.read_csv('product_details.csv')
productGroup_df = pd.read_csv('Product_Group.csv')

print("Sales type: ", sales_df.dtypes)

sales_df['TotalAmount'] = sales_df['UnitPrice'] * sales_df['Quantity']
